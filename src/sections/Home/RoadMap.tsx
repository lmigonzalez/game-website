    ...
    <section className='py-24'>
      <div>
        ...
        <div className="relative flex h-[1000px] flex-col items-center justify-between ">
          ...
          {/* road map item*/}
          <div className="relative z-20 mt-8 flex h-32 w-[600px] items-center justify-between">
          ...
          <div className="relative z-20 flex h-32 w-[600px] items-center justify-between">
          ...
          {/* road map item*/}
          <div className="relative z-20 mb-8 flex h-32 w-[600px] items-center justify-between">
