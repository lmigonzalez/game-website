...
const HowToMint = () => {
  return (
    <section className={`${poppins.className} pt-20 bg-transparent`}>
      ...
      <div className="hide-scroll-bar relative mt-24 h-[320px] w-full overflow-y-hidden overflow-x-scroll">
