      ...
      <div className="w-[750px] max-w-full rounded-lg bg-white text-black">
        ...
        <div className="flex items-center justify-between space-x-6 py-8 px-8">
			<form className='flex flex-col'>
				...
				<input type='text' className='bg-white border-b-[2px] border-black mb-4'/>
				<label>Card Number</label>
				<input type='number' className='bg-white border-b-[2px] border-black mb-4'/>
				...
				<label>CVV</label>
				<input type='number' className='bg-white border-b-[2px] border-black mb-4 w-fit'/>
			</form>
        </div>

        <div className="flex justify-end items-center px-8 py-4 text-black space-x-3">
