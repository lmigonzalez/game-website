    ...
    <div className="absolute top-0 left-0 z-20 flex h-full w-full items-center justify-center bg-black bg-opacity-70">
      <div className="w-[750px] max-w-full rounded-lg bg-white text-black">
        ...
        <div className='py-8 px-16'>
          <div className='h-[335px] w-[628px] max-w-full m-auto flex items-center justify-center bg-[#B8B8B8]'>
            <Image src="/youtube.png" alt="" width={50} height={50} />
          </div>
        </div>

		<div className='flex justify-center py-7 border-solid border-t-[2px] border-[#CDD6D7]'>
		<button type="submit">
              <p className='orange-gradient text-white h-14 w-48 rounded-full flex items-center justify-center'>Next</p>
            </button>
		</div>
      </div>
    </div>
