  ...
  return (
    <>
      ...
      <section className="relative flex min-h-screen">
        ...
        <div className="flex w-1/2 items-center justify-start bg-[url('/hot-air-balloons.jpg')] bg-cover bg-center bg-no-repeat">
          <strong className="absolute top-0 left-0  py-16 px-11 text-black">
            Logo Here
          </strong>
          <div className="ml-11 w-60 rounded-xl bg-black bg-opacity-20 p-4 text-white backdrop-blur-lg">
        ...
        <div className="relative flex w-1/2 flex-col items-center justify-center px-4 text-black">
